...
import agent as ag  # 复用 SeewoAgent + tracer + _OTEL_AVAILABLE
...
@app.get("/health")
def health():
    return {"status": "ok", "otel_enabled": ag._OTEL_AVAILABLE}
